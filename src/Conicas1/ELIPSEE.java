...
//final
    public void imprimirelipse(){
        System.out.println("Distancia semi ejes: "+distanciaSemiejes());
        System.out.println("Permimetro de la Elipse: "+perimetroElipse());
        System.out.println("Area de la Elise: "+area(6.45f,12.44f));
    }
}
